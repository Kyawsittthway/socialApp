...
class ConversationPage extends StatelessWidget {
  const ConversationPage({required this.peer, Key? key}) : super(key: key);
  final UserVO peer;

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ConversationBloc(peerId: peer.id),
                ...
                Consumer<ConversationBloc>(
                  builder: (context, bloc, child) => Visibility(
                    ...
                    child: Container(
                      ...
                      child: Image.file(File(bloc.selectedFile?.path ?? "")),
                    ),
                  ),
                )
              ],
